...
#if defined(KYNEMA_FMB_ENABLE_CUDSS)
    static constexpr dss::Algorithm algorithm_device = dss::Algorithm::CUDSS;
#elif defined(KYNEMA_FMB_ENABLE_CUSOLVERSP)
...
#if defined(KYNEMA_FMB_ENABLE_MKL)
