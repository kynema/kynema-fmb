...
# ./recipes/build_recipe_macos.sh <path_to_kynema_fmb_root> <path_to_spack_root>
# -----------------------------------------------------------------------------
...
spack load kokkos kokkos-kernels netdcf-c suite-sparse eigen googletest yaml-cpp #llvm cppcheck
...
cmake .. \
  ...
  -DKYNEMA_FMB_ENABLE_CUSOLVERSP=ON \
